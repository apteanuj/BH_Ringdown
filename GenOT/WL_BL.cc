...
int main(int argc, char **argv)
{
  ...
  Real lamb[200000], r[200000], thi[200000], E[200000], L[200000], Q[200000];
  Real rpp[200000], thipp[200000], Epp[200000], Lpp[200000], Qpp[200000];
  ...
  const Real lstart = (Real)atof(argv[3]);
